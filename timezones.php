<?php
global $wpdb;
$create_timezones_table = "CREATE TABLE IF NOT EXISTS `" . $wpdb->prefix  . "wcs_timezones` (
...
$insert_timezones_values = "INSERT INTO `" . $wpdb->prefix . "wcs_timezones` (`id`, `GMT`, `name`) VALUES
