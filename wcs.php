...
function wcs3_load_plugin() {
	...
	if ( is_admin() && get_option( 'wcs3_activate' ) == 'weekly-class-schedule' ) {
		delete_option( 'wcs3_activate' );
...
function wcs3_install() {
    add_option( 'wcs3_activate', 'weekly-class-schedule' );
}
